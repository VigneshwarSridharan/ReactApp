                ...
                <View style={styles.container}>
                    <ScrollView>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: "center", marginBottom: 30 }}>
                            <View style={{ flex: 1 }}>
                                <Text style={{ color: '#e67e22', fontSize: 18, marginBottom: 10 }}>From:</Text>
                                <TouchableOpacity activeOpacity={1} onPress={() => {
                                    this.props.navigation.navigate('AirportcodeScreen', { selectAirport: this.selectAirport, select: 'from' })
                                }} >
                                    <Text style={{ padding: 5, borderBottomColor: '#ccc', borderBottomWidth: 1, color: '#333', fontSize: 24 }}>
                                        {this.state.fromDsp || ' '}
                                    </Text>
                                </TouchableOpacity>
                            </View>
                            ...
                            <View style={{ flex: 1 }}>
                                <Text style={{ color: '#e67e22', fontSize: 18, marginBottom: 10 }}>To:</Text>
                                <TouchableOpacity activeOpacity={1} onPress={() => {
                                    this.props.navigation.navigate('AirportcodeScreen', { selectAirport: this.selectAirport, select: 'to' })
                                }} >
                                    <Text style={{ padding: 5, borderBottomColor: '#ccc', borderBottomWidth: 1, color: '#333', fontSize: 24 }}>
                                        {this.state.toDsp || ' '}
                                    </Text>
